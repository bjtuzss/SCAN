...
class SCRN(nn.Module):
    ...
    def __init__(self, channel=32):
        ...
        self.reasoning = GloRe_Unit(32, 4)
    ...
    def forward(self, x):
        ...
        #pred_s = self.reasoning(pred_s)
        pred_s = F.interpolate(pred_s, size=size, mode='bilinear', align_corners=True)
